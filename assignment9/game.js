...
var G = (function () {
    ...
    var check_which_connection = function(x,y) {
    ...
    var checks_for_connections = function () {
        for (let i = 0; i <= 2; i++) {
    ...
    return {
        ...
        keyDown : function (key) {
            ...
            //     display = true;
            //     for (let i = 0; i < compArr.length; i++) {
            //         PS.debug("the comp id is: " + compArr[i].id +", connection status is " + compArr[i].isConnected+"\n");
            //     }
            //     PS.debug("endpoint array b1:" + endPointArr[0][0] + " " +endPointArr[0][1] +"\n");
            //     PS.debug("endpoint array r2:" + endPointArr[1][0] + " " +endPointArr[1][1] +"\n");
            //     PS.debug("endpoint array g3:" + endPointArr[2][0] + " " +endPointArr[2][1] +"\n");
